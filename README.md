...
* WhatsApp Bot Multi Device [`DikaArdnt/Hisoka-Morou`](https://github.com/ll-Hunoter-ll/Hisoka-Morou)
...
```bash
git clone https://github.com/ll-Hunoter-ll/Hisoka-Morou
cd Hisoka-Morou
npm install
```
...
Editing Number Owner & session name in [`config.js`](https://github.com/ll-Hunoter-ll/Hisoka-Morou/blob/master/config.js)
